    ...
    >(
        () => [
            ...
            },
            {
                ...
                brief: "System kontroli wersji, który umożliwia śledzenie zmian w kodzie źródłowym, zarządzanie historią projektu oraz współpracę wielu programistów poprzez rozgałęzianie i scalanie kodu.",
            },
            {
                Icon: FaFilePdf,
                label: "pdf-lib",
                link: "https://pdf-lib.js.org/",
                brief: "Biblioteka JavaScript pozwalająca na tworzenie, modyfikowanie i manipulowanie plikami PDF w aplikacjach webowych i Node.js.",
            },
            {
                Icon: FaNodeJs,
                label: "Node.js",
                link: "https://nodejs.org/en",
                brief: "Środowisko uruchomieniowe JavaScript, które umożliwia wykonywanie kodu JavaScript po stronie serwera, wykorzystując silnik V8 i model asynchroniczny oparty na zdarzeniach.",
            },
        ],
        []
    );
